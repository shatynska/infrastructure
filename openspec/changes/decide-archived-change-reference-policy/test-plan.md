...
| `test_the_walk_reaches_the_tracked_files_under_the_agent_directory` | design Decision 7's insistence that `.claude` is pruned only at `worktrees` |
...
repository root, with all 111 tests green. Exactly one is red today:
