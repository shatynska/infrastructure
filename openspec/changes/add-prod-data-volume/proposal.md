...
- Add `production_data`'s non-secret configuration (`volume_name = "production_data"`, `volume_size = 10`) to `environments/prod/terraform.tfvars`, per the project's committed-tfvars convention.
