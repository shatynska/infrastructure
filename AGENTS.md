...
**Scenario titles are not covered by either.** A citation naming a scenario inside a requirement rots the same way and nothing reads it; `docs/backlog.md` entry 47 carries the entry that would.
