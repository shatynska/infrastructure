...
> **NOT YET IN EFFECT.** This document records a decision taken on 2026-09-11; the repository does not match it yet. What it describes was to arrive through `docs/change-queue.md` entries 61, 62, 63 and 64, in that order. Entries 61, 62, 63 and 64 have archived; **75 alone remains**, and whoever archives it deletes this banner. Until then, read this as the target and the tree as the present.
>
