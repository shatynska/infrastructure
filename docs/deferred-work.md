...
The visible cost is a scenario whose title says *Environment* while the prose under it says *stack*, and a test module named for an axis it no longer asserts.
